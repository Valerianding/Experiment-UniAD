...
from src.track_head.anchor_free_head import AnchorFreeHead
from src.utils.utils import Conv2d, Linear
from src.modules.ffn import FFN
from src.track_head.transforms import bbox_cxcywh_to_xyxy,bbox_xyxy_to_cxcywh
from src.utils.builder import build_activation_layer, build_positional_encoding, build_transformer
from src.mmdet3d.utils import multi_apply
...
class DETRHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        #TODO change to self.loss_cls.use_sigmoid
        if True:
