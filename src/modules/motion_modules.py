...
from src.utils.utils import norm_points, pos2posemb2d, trajectory_coordinate_transform
...
class MotionTransformerDecoder(nn.Module):
    ...
    def forward(self,
        ...
        for lid in range(self.num_layers):
            ...
            # e_time = time.time()
            # print("motion head modules infer {}".format(1000 * (e_time - s_time)))
...
class TrackAgentInteraction(nn.Module):
    ...
    def __init__(self,
                 ...
                 norm_cfg=None,
                 init_cfg=None):
        super(TrackAgentInteraction, self).__init__()
...
class IntentionInteraction(nn.Module):
    ...
    def __init__(self,
                 ...
                 norm_cfg=None,
                 init_cfg=None):
        super(IntentionInteraction, self).__init__()
