...
from src.utils.builder import build_attention, build_feedforward_network, build_norm_layer, build_dropout
from src.utils.utils import ModuleList, Sequential
from src.utils.utils import ConfigDict
from src.modules.multi_scale_deform_attn import MultiScaleDeformableAttnFunction_fp32
...
class MotionTransformerAttentionLayer(nn.Module):
    ...
    def __init__(self,
        ...
        super(MotionTransformerAttentionLayer, self).__init__()
...
class MotionDeformableAttention(nn.Module):
    ...
    def __init__(self,
                 ...
                 norm_cfg=None,
                 init_cfg=None):
        super(MotionDeformableAttention, self).__init__()
...
class CustomModeMultiheadAttention(nn.Module):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(CustomModeMultiheadAttention, self).__init__()
